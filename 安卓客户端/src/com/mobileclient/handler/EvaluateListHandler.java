	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (evaluate != null) { 
            ...
            if ("evaluateId".equals(tempString)) 
            	...
            	evaluate.setRoomObj(valueString); 
            else if ("userObj".equals(tempString)) 
            	evaluate.setUserObj(valueString); 
            else if ("evalueScore".equals(tempString)) 
            	evaluate.setEvalueScore(new Integer(valueString).intValue());
            else if ("evaluateContent".equals(tempString)) 
            	evaluate.setEvaluateContent(valueString); 
