			...
			public void onClick(View v) {
				try {
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "登陆密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cardNumber.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "身份证号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_userScore.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "会员积分输入不能为空!", Toast.LENGTH_LONG).show();
