...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_userScore = (TextView)convertView.findViewById(R.id.tv_userScore);
	  /*设置各个控件的展示内容*/
	  ...
	  try {holder.tv_birthday.setText("生日：" + mData.get(position).get("birthday").toString().substring(0, 10));} catch(Exception ex){}
	  ...
	  holder.tv_userScore.setText("会员积分：" + mData.get(position).get("userScore").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
