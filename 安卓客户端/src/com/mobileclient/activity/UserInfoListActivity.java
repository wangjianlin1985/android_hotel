				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","sex","birthday","city","photo","userScore" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.tv_city,R.id.iv_photo,R.id.tv_userScore,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < userInfoList.size(); i++) {
				...
				map.put("userScore", userInfoList.get(i).getUserScore());
				list.add(map);
			}
		} catch (Exception e) { 
