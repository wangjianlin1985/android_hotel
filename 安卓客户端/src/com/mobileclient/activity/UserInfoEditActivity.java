...
public class UserInfoEditActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ET_userScore = (EditText) findViewById(R.id.ET_userScore);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "登陆密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cardNumber.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "身份证号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					userInfo.setMoneyValue(Float.parseFloat(ET_moneyValue.getText().toString()));
					/*验证获取会员积分*/ 
					if(ET_userScore.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "会员积分输入不能为空!", Toast.LENGTH_LONG).show();
						ET_userScore.setFocusable(true);
						ET_userScore.requestFocus();
						return;	
					}
					userInfo.setUserScore(Integer.parseInt(ET_userScore.getText().toString()));
					/*调用业务逻辑层上传用户信息信息*/
	...
	private void initViewData() {
		...
		this.ET_moneyValue.setText(userInfo.getMoneyValue() + "");
		this.ET_userScore.setText(userInfo.getUserScore() + "");
	}
	@Override
