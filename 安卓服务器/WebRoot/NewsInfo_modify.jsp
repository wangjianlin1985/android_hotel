...
function checkForm() {
    ...
    var newsDate = document.getElementById("newsInfo.newsDate").value;
    if(newsDate=="") {
        alert('请输入发布日期!');
        return false;
    }
...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>发布日期:</td>
    <td width=70%><input id="newsInfo.newsDate" name="newsInfo.newsDate" type="text" size="20" value='<%=newsInfo.getNewsDate() %>'/></td>
  </tr>
