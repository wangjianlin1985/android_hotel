...
public class MoneyRecordQueryActivity extends Activity {
	// 声明查询按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionMoneyRecord.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionMoneyRecord.setUserObj("");
			}
			@Override
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*获取查询参数*/
					queryConditionMoneyRecord.setHappenTime(ET_happenTime.getText().toString());
					Intent intent = getIntent();
					//这里使用bundle绷带来传输数据
					Bundle bundle =new Bundle();
					//传输的内容仍然是键值对的形式
					bundle.putSerializable("queryConditionMoneyRecord", queryConditionMoneyRecord);
