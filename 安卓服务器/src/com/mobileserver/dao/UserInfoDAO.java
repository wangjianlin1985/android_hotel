...
public class UserInfoDAO {
	...
	public List<UserInfo> QueryUserInfo(String user_name,String name,Timestamp birthday,String cardNumber,String city) {
		...
		try {
			...
			while (rs.next()) {
				...
				userInfo.setMoneyValue(rs.getFloat("moneyValue"));
				userInfo.setUserScore(rs.getInt("userScore"));
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		try {
			/* 构建sql执行插入新用户信息 */
			String sqlString = "insert into UserInfo(user_name,password,name,sex,birthday,cardNumber,city,photo,moneyValue,userScore) values (";
			...
			sqlString += userInfo.getMoneyValue() + ",";
			sqlString += userInfo.getUserScore();
			sqlString += ")";
	...
	public String UpdateUserInfo(UserInfo userInfo) {
		...
		try {
			...
			sql += "moneyValue=" + userInfo.getMoneyValue() + ",";
			sql += "userScore=" + userInfo.getUserScore();
