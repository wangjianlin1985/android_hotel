...
public class UserInfoService {
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		params.put("moneyValue", userInfo.getMoneyValue() + "");
		params.put("userScore", userInfo.getUserScore() + "");
	...
	public List<UserInfo> QueryUserInfo(UserInfo queryConditionUserInfo) throws Exception {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				userInfo.setMoneyValue((float) object.getDouble("moneyValue"));
				userInfo.setUserScore(object.getInt("userScore"));
