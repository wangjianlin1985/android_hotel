			...
			public void onClick(View v) {
				try {
					...
					if(ET_newsContent.getText().toString().equals("")) {
						Toast.makeText(NewsInfoAddActivity.this, "优惠内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_newsDate.getText().toString().equals("")) {
						Toast.makeText(NewsInfoAddActivity.this, "发布日期输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传优惠信息信息*/
					NewsInfoAddActivity.this.setTitle("正在上传优惠信息信息，稍等...");
