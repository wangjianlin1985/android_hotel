...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>留言标题:</td>
    <td width=70%><input id="guestBook.title" name="guestBook.title" type="text" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>留言时间:</td>
    <td width=70%><input id="guestBook.addTime" name="guestBook.addTime" type="text" size="30" /></td>
  </tr>
