...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>账户余额:</td>
    <td width=70%><input id="userInfo.moneyValue" name="userInfo.moneyValue" type="text" size="8" value='<%=userInfo.getMoneyValue() %>'/></td>
  </tr>

  <tr>
    <td width=30%>会员积分:</td>
    <td width=70%><input id="userInfo.userScore" name="userInfo.userScore" type="text" size="8" value='<%=userInfo.getUserScore() %>'/></td>
  </tr>
